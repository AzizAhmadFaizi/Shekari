...
@section('content')
    ...
    <div class="card-header border-bottom">
        ...
        @if (auth()->user()->role_id == 2)
            <button class="btn btn-primary show_modal"><span data-feather='plus'></span> کمپنی جدید</button>
        @endif
    </div>
    <div class="card m-1">
                                ...
                                <div class="d-flex align-items-end mt-75 ms-1">
                                    <div>
                                        <label for="product-upload"
                                            class="btn btn-sm btn-primary mb-75 me-75">انتخاب</label>
                                        <input type="file" id="product-upload" name="image" hidden accept="image/*" />
                                        <button type="button" id="product-reset"
                                            class="btn btn-sm btn-outline-secondary mb-75">حذف</button>
...
@section('scripts')
    ...
    <script>
        ...
        const resetForm = () => {
            ...
            $("#organizationModal").html("کمپنی جدید");
        }

        $(document).on('click', '.edit_btn', function() {
            $("#organizationModal").html("تغییر کمپنی");
